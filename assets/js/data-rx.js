...
5) غرغرة ماء دافئ مع ملح`,
    notes: ['حساسية البنسلين: Azithromycin 500 مج اليوم الأول ثم 250 مج لأربعة أيام.', 'الأطفال: أموكسيسيلين 50 مج/كجم/يوم مقسمة على جرعتين.', 'إكمال 10 أيام ضروري لمنع الحمى الروماتيزمية.'] },
...
5) استحمام قصير بماء فاتر مع غسول خالٍ من الصابون والعطور`,
    notes: ['لا تستخدم الكورتيزون القوي على الوجه أو عند الأطفال الصغار لفترات طويلة.', 'قشور عسلية أو صديد = عدوى ثانوية تحتاج مضاداً حيوياً.'] },
...
window.HANDOUTS = [
  { id: 'h-fever-child', title: 'الحرارة عند الأطفال', tags: ['حرارة', 'طفل', 'سخونة'],
    text: `تعليمات للأهل — الحرارة عند الطفل

• الحرارة عرض وليست مرضاً، والهدف راحة الطفل وليس رقم الترمومتر.
• أعطِ الخافض إذا كان الطفل متضايقاً: باراسيتامول 15 مج/كجم كل 6 ساعات، أو إيبوبروفين 10 مج/كجم كل 8 ساعات (فوق 6 شهور).
• أكثر من السوائل، وألبسه ملابس خفيفة، ولا تستخدم الكمادات الباردة أو الكحول.
• لا تعطِ الأسبرين للأطفال إطلاقاً.

راجع الطوارئ فوراً إذا:
• كان عمر الطفل أقل من 3 شهور وحرارته 38 أو أكثر.
• خمول شديد أو صعوبة في الإيقاظ.
• صعوبة في التنفس أو ازرقاق.
• تشنجات.
• طفح جلدي لا يختفي بالضغط عليه.
• رفض الشرب أو علامات جفاف (قلة تبول، جفاف الفم، بكاء بدون دموع).
• استمرار الحرارة أكثر من 3 أيام.` },

  { id: 'h-ors', title: 'محلول الجفاف في المنزل', tags: ['جفاف', 'اسهال', 'ors'],
    text: `طريقة استخدام محلول معالجة الجفاف

• ذوّب كيساً واحداً في لتر ماء نظيف (اتبع تعليمات العبوة بدقة — لا تزد الماء ولا تنقصه).
• أعطِ ملعقة صغيرة كل دقيقة إلى دقيقتين، ببطء، حتى لو تقيأ الطفل.
• إذا تقيأ، انتظر 10 دقائق ثم استأنف بكميات أصغر.
• بعد كل إسهال أعطِ كمية إضافية.
• استمر بالرضاعة الطبيعية أو الحليب المعتاد — لا تخففه ولا توقفه.
• استمر بالطعام الطبيعي: أرز، بطاطس، خبز، موز، زبادي.
• المحلول المحضّر صالح 24 ساعة، ويُحفظ في الثلاجة.

تجنّب: العصائر المحلاة والمشروبات الغازية ومشروبات الطاقة — تزيد الإسهال.

راجع فوراً عند: قلة التبول، خمول، عيون غائرة، بكاء بلا دموع، دم في البراز، أو قيء مستمر يمنع الشرب.` },
